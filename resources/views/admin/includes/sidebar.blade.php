<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 854px;"></div>
            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <text class="d-block">{{ auth()->user()->name }}</text>
                        </div>
                    </div>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-legacy nav-child-indent"
                            role="menu"
                            ...
                            @if(auth()->user()->is_admin)
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="nav nav-treeview" style="display: block;">
                                            @foreach($group->checklists as $checklist)
                                                <li class="nav-item">
                                                    <a href="{{route('admin.checklist_groups.checklists.edit' ,[$group->id , $checklist->id ])}}"
                                                       class="nav-link ">
                                ...
                                <li class="nav-item ml-2 mb-2 text-muted"> pages</li>
                                ...
                                @endforeach
                                <li class="nav-item ml-1 mb-2"> Users</li>
                                <li class="nav-item">
                            ...
                            @else
                                        ...
                                        <a class="nav-link">
                                            ...
                                            <p>
                                                ...
                                                @elseif($group['is_updated'])
                                                    <span class="badge badge-primary right">UPD</span>
                                                @endif
                                            </p>
                                        </a>
                                        <ul class="nav nav-treeview" style="display: block;">
                                                    ...
                                                    <a href="{{route('user.checklists.show' , [$checklist['id']])}}"
                                                       class="nav-link ">
                                                        ...
                                                        <p>
                                                            ...
                                                            @if($checklist['is_new'])
                                                                <span class="badge badge-info right " style="right:0.5rem ">new</span>
                                ...
                                @endforeach
                            @endif
                            <li class="nav-item ml-1 mb-2"> Others</li>
                            <li class="nav-item">
        ...
        <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="height: 67.1082%; transform: translate(0px, 0px);"></div>
            </div>
        </div>
